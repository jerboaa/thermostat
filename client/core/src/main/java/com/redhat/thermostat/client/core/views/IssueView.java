...
public abstract class IssueView extends BasicView implements UIComponent {
    ...
    public void removeIssueActionListener(ActionListener<IssueView.IssueAction> listener) {
