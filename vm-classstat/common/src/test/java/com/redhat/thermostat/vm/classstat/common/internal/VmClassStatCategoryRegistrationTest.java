...
public class VmClassStatCategoryRegistrationTest extends ServiceLoaderTest<CategoryRegistration> {

    public VmClassStatCategoryRegistrationTest() {
        super(CategoryRegistration.class, STORAGE_SERVICES, VmClassStatCategoryRegistration.class);
    }
