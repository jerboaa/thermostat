...
public class VmIoStatCategoryRegistrationTest {
    ...
    public void serviceLoaderCanLoadRegistration() {
        ...
        expectedClassNames.add(VmIoStatCategoryRegistration.class.getName());
        expectedClassNames.add(DAOImplCategoryRegistration.class.getName());
        ServiceLoader<CategoryRegistration> loader = ServiceLoader.load(CategoryRegistration.class, VmIoStatCategoryRegistration.class.getClassLoader());
        ...
        for (CategoryRegistration r: loader) {
            ...
            if (r.getClass().getName().equals(VmIoStatCategoryRegistration.class.getName())) {
                vmCpuStatCatReg = r;
            }
            registrations.add(r);
        }
