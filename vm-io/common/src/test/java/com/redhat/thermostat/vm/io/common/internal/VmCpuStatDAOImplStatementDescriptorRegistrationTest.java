...
public class VmCpuStatDAOImplStatementDescriptorRegistrationTest {
    ...
    public void serviceLoaderCanLoadRegistration() {
        ...
        expectedClassNames.add(VmIoStatDAOImplStatementDescriptorRegistration.class.getName());
        ServiceLoader<StatementDescriptorRegistration> loader = ServiceLoader.load(StatementDescriptorRegistration.class, VmIoStatDAOImplStatementDescriptorRegistration.class.getClassLoader());
        ...
        for (StatementDescriptorRegistration r: loader) {
            ...
            if (r.getClass().getName().equals(VmIoStatDAOImplStatementDescriptorRegistration.class.getName())) {
                vmCpuStatReg = r;
            }
            registrations.add(r);
        }
