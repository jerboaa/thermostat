...
public class ActivatorTest {
    ...
    public void verifyActivatorRegistersServices() throws Exception {
        ...
        context.registerService(VmIoViewProvider.class, viewProvider, null);

        Activator activator = new Activator();

        activator.start(context);

        assertTrue(context.isServiceRegistered(InformationService.class.getName(), VmIoServiceImpl.class));
