...
public class Activator implements BundleActivator {
    ...
    private ServiceRegistration<InformationService> reg;

    @Override
    public void start(final BundleContext context) throws Exception {
        Class<?>[] deps = new Class<?>[] {
                VmIoStatDAO.class,
                VmIoViewProvider.class,
        ...
        tracker = new MultipleServiceTracker(context, deps , new Action() {
            ...
            public void dependenciesAvailable(DependencyProvider services) {
                ...
                properties.put(InformationService.KEY_SERVICE_ID, VmIoService.SERVICE_ID);
                reg = context.registerService(InformationService.class, service, properties);
            }
