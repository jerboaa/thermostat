...
public class ActivatorTest {
    ...
    public void verifyActivatorRegistersServices() throws Exception {
        ...
        context.registerService(VmIoStatDAO.class, dao, null);

        Activator activator = new Activator();

        activator.start(context);

        assertTrue(context.isServiceRegistered(VMStatPrintDelegate.class.getName(), VmIoStatPrintDelegate.class));
