...
class AcceptedLocalSocketChannelImpl extends ThermostatLocalSocketChannelImpl {

    private SelectionKey key;
    private SocketHelper helper;
    
    AcceptedLocalSocketChannelImpl(String name, UnixSocketChannel impl, SelectionKey key) {
        this(name, impl, key, new SocketHelper());
    }
    
    AcceptedLocalSocketChannelImpl(String name, UnixSocketChannel impl, SelectionKey key, SocketHelper helper) {
        super(name, impl);
        this.key = key;
        this.helper = helper;
    }
    ...
    static class SocketHelper {
        void closeSocket(AcceptedLocalSocketChannelImpl channel) throws IOException {
            channel.implClose();
        }
    }
