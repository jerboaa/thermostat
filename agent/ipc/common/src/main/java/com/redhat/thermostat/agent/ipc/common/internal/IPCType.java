...
public enum IPCType {
    ...
    // Reverse lookup
    private static final Map<String, IPCType> valuesMap;
    ...
    static {
        ...
        for (IPCType type : IPCType.values()) {
            ...
            if (value != null) {
                tempValuesMap.put(value, type);
            }
        }
        valuesMap = Collections.unmodifiableMap(tempValuesMap);
    }
    
    private IPCType(String configValue) {
    ...
    public static IPCType fromConfigValue(String value) {
        return valuesMap.get(value);
    }
    
    // For testing purposes only
    static Map<String, IPCType> getValuesMap() {
        return valuesMap;
    }
