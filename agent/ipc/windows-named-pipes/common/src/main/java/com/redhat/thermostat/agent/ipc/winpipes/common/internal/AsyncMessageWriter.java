...
public class AsyncMessageWriter extends MessageWriter {
    ...
    public AsyncMessageWriter(WritableByteChannel channel) {
        this(channel, new MessageLimits());
    }

    AsyncMessageWriter(WritableByteChannel channel, MessageLimits limits) {
        super(limits);
    ...
    public synchronized void enqueueForWriting(ByteBuffer buf) throws IOException {
        ...
        // Split potentially large message into smaller messages and add headers
