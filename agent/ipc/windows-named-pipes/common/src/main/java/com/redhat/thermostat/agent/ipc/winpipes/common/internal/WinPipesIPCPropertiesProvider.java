...
public class WinPipesIPCPropertiesProvider implements IPCPropertiesProvider {

    @Override
    public WinPipesIPCProperties create(Properties props, File propFile) throws IOException {
        return new WinPipesIPCProperties(props, propFile);
    }
