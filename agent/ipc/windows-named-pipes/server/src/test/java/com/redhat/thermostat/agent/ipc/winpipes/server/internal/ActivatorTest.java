...
import com.redhat.thermostat.agent.ipc.winpipes.server.internal.Activator.IPCServiceHelper;
import com.redhat.thermostat.testutils.StubBundleContext;

public class ActivatorTest {
    
    private Activator activator;
    private WinPipesServerTransport service;
    
    @Before
    public void setUp() throws Exception {

        IPCServiceHelper helper = mock(IPCServiceHelper.class);
        service = mock(WinPipesServerTransport.class);
        when(helper.createTransport()).thenReturn(service);
        
        activator = new Activator(helper);
    }
