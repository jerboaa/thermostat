 ...
 * the ability to connect to IPC servers. A concrete instance of this
 * interface can be obtained by calling {@link ClientIPCServiceFactory#getIPCService()}.
 */
public interface ClientIPCService {
     ...
     * @param name - name of the server to connect to, must not be null
