...
/**
 */
class PropertyChangeHandler<T> {
    private Collection<ChangeListener<? super T>> changeListeners;
    private Collection<InvalidationListener> invalidationListeners;

    private Property<T> property;
    private T value;

    public PropertyChangeHandler(Property<T> property) {
    ...
    public void firePropertyChangeEvent() {
        ...
        for (ChangeListener listener : changeListeners) {
            listener.changed(property, oldValue, value);
        }
    }

    private boolean hasChanged() {
        T newValue = property.getValue();
