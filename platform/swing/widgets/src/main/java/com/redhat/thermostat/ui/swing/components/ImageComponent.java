 ...
 */
public class ImageComponent extends ThermostatComponent {

    private BufferedImage buffer;

    public ImageComponent(BufferedImage buffer) {
        this.buffer = buffer;
    }
    ...
    protected void paintComponent(Graphics2D graphics) {
        ...
        int x = getWidth()/2 - buffer.getWidth()/2 + 1;
        int y = getHeight()/2 - buffer.getHeight()/2 + 1;

        graphics.drawImage(buffer, x, y, null);
    }
}
