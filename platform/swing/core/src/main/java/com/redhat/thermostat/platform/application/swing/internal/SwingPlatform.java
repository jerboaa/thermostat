...
public class SwingPlatform implements Platform {
    ...
    public SwingPlatform(ApplicationService applicationService) {
        this.applicationService = applicationService;
        this.eventQueue = new EventQueue("Platform Application Thread");
    }

    @Override
    public void queueOnApplicationThread(Runnable runnable) {
        eventQueue.runLater(runnable);
    }
    ...
    public boolean isApplicationThread() {
        return eventQueue.isEventDispatchThread();
    }
