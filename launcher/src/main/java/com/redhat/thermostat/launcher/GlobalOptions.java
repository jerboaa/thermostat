...
public enum GlobalOptions {
     ...
     */
    SKIP_SETUP("--skip-setup", "skip running the thermostat setup wizard on first run and run the specified command")
    ;

    private final String optString;
    private final String description;

    private GlobalOptions(String optString, String description) {
