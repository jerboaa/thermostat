...
package org.jboss.byteman.thermostat.helper.transport.stdout;
...
class StdOutTransport extends Transport {
    ...
    protected StdOutTransport() {
        super(0 /* no send threshold */, Integer.MAX_VALUE /* no lose threshold */);
    }

    @Override
    protected void transferToPeer(ArrayList<BytemanMetric> records) {
        for (BytemanMetric record: records) {
