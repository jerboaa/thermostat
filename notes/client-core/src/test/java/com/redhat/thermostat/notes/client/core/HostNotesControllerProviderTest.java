...
public class HostNotesControllerProviderTest {
    ...
    @Test
    public void testReturnedControllerNotesHaveMatchingAgentId() {
        HostRef ref = mock(HostRef.class);
        when(ref.getAgentId()).thenReturn("foo-agentid");
        HostNotesControllerProvider provider = new HostNotesControllerProvider(clock, appSvc, dao, viewProvider);
        HostNotesController controller = provider.getInformationServiceController(ref);
        HostNote note = controller.createNewNote(100l, "content");
